...
class DataTransformation:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact,
        ...
        try:
            ...
            self._schema_config = read_yaml_file(file_path=SCHEMA_FILE_PATH) # what you drop something instead of hard codding do direct change in yaml file an dread it , yhrn you are sorted
